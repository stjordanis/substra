...
client = substra.Client(profile_name="node-1", backend="local")
# Uncomment to execute on a running Substra platform
# client = substra.Client(profile_name='node-1', backend='remote')
# client.login(username="node-1", password="p@$swr0d44")
