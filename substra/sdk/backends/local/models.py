...
class Dataset(_Model):
    ...
    class Meta:
        storage_only_fields = ('data_opener', 'description')
...
class Objective(_Model):
    ...
    class Meta:
        storage_only_fields = ('metrics', 'description')
...
class _Algo(_Model):
    ...
    class Meta:
        storage_only_fields = ('file', 'description', )
...
class ComputePlan(_Model):
    compute_plan_id: str
    status: Status
    traintuple_keys: List[str]
    composite_traintuple_keys: List[str]
    aggregatetuple_keys: List[str]
    testtuple_keys: List[str]
